...
internal final class SearchAlgorithmSelector: Sendable {
    
    func selectAlgorithm(for term: String, type: SearchType, options: SearchOptions) -> SearchAlgorithm {
...
internal protocol SearchAlgorithm: Sendable {
    func search(term: String, type: SearchType, options: SearchOptions) async throws -> [SearchMind.SearchResult]
}

/// Algorithm for exact string matching
internal struct ExactMatchAlgorithm: SearchAlgorithm {
    func search(term: String, type: SearchType, options: SearchOptions) async throws -> [SearchMind.SearchResult] {
...
internal struct FuzzyMatchAlgorithm: SearchAlgorithm {
    func search(term: String, type: SearchType, options: SearchOptions) async throws -> [SearchMind.SearchResult] {
        let searchTerm = options.caseSensitive ? term : term.lowercased()
...
internal struct PatternMatchAlgorithm: SearchAlgorithm {
    func search(term: String, type: SearchType, options: SearchOptions) async throws -> [SearchMind.SearchResult] {
        let searchTerm = options.caseSensitive ? term : term.lowercased()
